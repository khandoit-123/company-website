...
const initialState = {milk: 0, coffee: 0, hot_chocolate: 0, champagne: 0, orange_juice: 0, lime_water: 0, salad: 0, cake: 0, bruschetta: 0, noodle: 0, fried_rice: 0, fried_chicken: 0}
...
function reducer(state, action) {
    switch (action.type) {
        ...
        case 'add_choco':
            return { ...state, hot_chocolate: state.hot_chocolate + 1 };
        case 'minus_choco':
            return { ...state, hot_chocolate: Math.max(0, state.hot_chocolate - 1) };
        case 'add_salad':
...
const Order = () => {
    ...
    return(
        <div>
            <Checkout state={state} resetOrderState={resetOrderState}></Checkout>
                ...
                <div>                       
                    <section >
                        ...
                        <div className='flex flex-col items-center xl:flex-row xl:mx-40 xl:justify-between font-serif xl:px-30'>
                            ...
                            <div className={homediv}>
                                <img src="./icons_assets/chocolate.jpeg" alt='Hot Chocolate' className={picsize}></img>
                                <h3 className={cft}>Hot Chocolate ($3)</h3>
                                <div className="flex space-x-2">
